              ...
              <div class="card">
                <div class="card-body login-card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        <select class="form-control select2bs4" style="width: 100%;" name="states">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                          ...
                          <input type="text" disabled class="form-control" style="border-radius: 0 !important" required autocomplete="off" value="<?php echo $transaction['trans_office']; ?>">
                      </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <br>
                          ...
                          <div class="col-lg-9 col-md-9 col-sm-12">
                              ...
                              <table class="table table-sm table-bordered">
                                  ...
                                  <?php
                                      ...
                                      $mop_details_sql = "SELECT * FROM upti_mod WHERE mod_country = '$country' AND mod_status = '$get_mode_of_payment' AND mod_state = '$office_state'";
