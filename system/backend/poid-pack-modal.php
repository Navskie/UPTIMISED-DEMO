            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $code6 = $pack_fetch['package_six_code'];
                        $code66s = $pack_fetch['package_six_qty'];
                        $code66 = $code66s * $qty;
                    ...
                    <div class="col-12"><hr></div>
                        ...
                        <div class="col-12"><hr></div>
                          <div class="col-lg-3 col-md-3 col-sm-12">
                          <h5><?php echo $code6 ?></h5>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-12">
                              <?php
                                  $get_desc = "SELECT * FROM upti_items WHERE items_code = '$code6'";
                                  $get_desc_qry = mysqli_query($connect, $get_desc);
                                  $get_fetch = mysqli_fetch_array($get_desc_qry);
                              ?>
                              <h5><?php echo $get_fetch['items_desc']; ?></h5>
