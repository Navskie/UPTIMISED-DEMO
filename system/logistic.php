                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <?php
                                    $account = "SELECT * FROM stockist_request WHERE req_from = 'PHILIPPINES' AND req_status = 'To Pack' OR req_from = 'PHILIPPINES' AND req_status = 'On Process' ORDER BY id DESC";
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="text-center"><a href="reference-info2.php?poid=<?php echo $account_fetch['req_reference']; ?>" target="_blank" class="btn btn-sm btn-dark rounded-0"><?php echo $account_fetch['req_reference']; ?></a></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php } elseif ($status == 'On Process') { ?>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="submit" class="btn btn-info btn-sm" data-toggle="modal" data-target="#intransit<?php echo $account_fetch['id'] ?>">In Transit</button>
                                            </div>
                                        <?php } ?>
                                    </td>
                                  </tr>
                                <?php
                                        ...
                                        include 'backend/po-dhl-modal.php';
